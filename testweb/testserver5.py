...
@LastEditors: Baiy
@LastEditTime: 2018-11-18 08:46:28
...
def main():
    ...
    while True:
        ...
        """ 使用协成 """
        g = gevent.spawn(exchange_2_client,client_sock)
        # g.join() #协成创建后在休眠即可调度，这里不需要等待，下次accept时会去调度。
        ...
        # p1.start()
        # client_sock.close()  # 多进程会复制socket描述符
